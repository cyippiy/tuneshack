        ...
        <section className="unauth-container">
          ...
          <section className="splash-icons">
            <div className="splash-fans">
              ...
              <p>Get instant streaming of your purchases, follow your
            ...
            <img src="https://bandcamp.com/img/homepage_2015/signups-labels-icon@3x.png" />
              <p>Unified accounting and stats across all your artists, a
                ...
                payments on a per release basis, and a whole lot more.</p>
            <div className="learn-button">
              <button className="learn-more">Learn more</button>
            </div>
            </div>
          ...
          <section className="footer">
            <section className="foot-col">
              <Link className="fake" to="#">About Us</Link>
              <Link className="fake" to="#">Fair Trade Music</Link>
              <Link className="fake" to="#">Jobs</Link>
              <Link className="fake" to="#">Terms of Use</Link>
              <Link className="fake" to="#">Privacy</Link>
              <Link className="fake" to="#">Copyright Policy</Link>
            </section>
            <section className="foot-col">
              <Link className="fake" to="#">Gift Cards</Link>
              <Link className="fake" to="#">TuneShack Daily</Link>
              <Link className="fake" to="#">Facebook</Link>
              <Link className="fake" to="#">Contact/Help</Link>
            </section>
            <section className="foot-col">
            </section>
            <section className="foot-col">
              <p>Created By: Chris Yip</p>
            <Link className="contact-links" to="#">LinkedIn</Link>
            <Link className="contact-links" to="#">GitHub</Link>
              GitHub
            </section>
          </section>
        </section>
